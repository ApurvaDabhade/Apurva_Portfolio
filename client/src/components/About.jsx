    ...
    <section id="about">
      ...
      <div className="bento ab-bento fi">
        <div className="bento-card bc-bio bc-accent-blue ab-hover-card">
          ...
          <div className="callout">◈ &nbsp;Backend Developer · Full-Stack · UI/UX · Agentic AI</div>
          ...
          <div className="contact-links">
            ...
            <a href={profile.linkedin} target="_blank" rel="noreferrer" className="contact-link"><span className="cl-icon" style={{ fontSize: '.65rem' }}>in</span>linkedin.com/in/apurva-dabhade</a>
